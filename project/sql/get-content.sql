...
from money_diaries.blog_entry a 
inner join money_diaries.blog_entry__result__content__entries b
on a.result__ad_data__ad_entityid = b.id 
and a._dlt_id = b._dlt_parent_id
inner join money_diaries.blog_entry__result__content__entries__sections__body c 
